...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: [
      ...
      { url: '/favicon-v2.png', sizes: '167x167', type: 'image/png' },
      { url: '/favicon-v2.png', sizes: '152x152', type: 'image/png' },
      { url: '/favicon-v2.png', sizes: '120x120', type: 'image/png' }
    ],
    shortcut: '/favicon-v2.png',
    other: [
      { rel: 'apple-touch-icon-precomposed', url: '/favicon-v2.png' }
    ]
  },
  appleWebApp: {
    capable: true,
